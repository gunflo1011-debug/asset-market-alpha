import { getLocalActivationSnapshot, recordLocalActivation } from './localActivationCollector';
 ...
 */
export function recordActivationTransition(name: ActivationEventName): ActivationFunnelSnapshot {
