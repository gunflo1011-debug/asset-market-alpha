    ...
    <SafeAreaView style={styles.safe}>
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <View style={styles.container}>
          ...
          {buyer && status === 'SOLD' ? <View style={[styles.adoptionCard, adoptedItemId ? styles.adoptionSuccessCard : null]} accessibilityLabel={adoptedItemId ? 'Purchase saved privately in My Things' : 'Sale complete. Add this purchased Thing to My Things'}>
