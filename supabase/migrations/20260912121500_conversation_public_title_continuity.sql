-- Keep a participant-safe, buyer-visible title attached to Marketplace conversations.
-- The title comes only from the listing's frozen public snapshot; it never reads the
-- seller's current private Thing metadata.
