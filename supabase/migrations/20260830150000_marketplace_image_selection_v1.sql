-- Owner-controlled selection of private Thing photos for future Marketplace presentation.
-- This migration does not expose files publicly. It only records explicit seller intent.
...
comment on function public.set_my_item_image_marketplace_visibility(uuid,uuid,boolean) is
  'Lets an authenticated owner explicitly select up to six private Thing images for Marketplace use. This flag alone never grants file access.';
